...
SELECTING_LABEL = [5, 8] # digits are 1 and 4
NUM_PER1 = 1
NUM_PER2 =2999 
...
with tf.Session() as session:
    ...
    for iteration in xrange(ITERS):
        ...
        if iteration > 0:
            ...
            _, _pred_cls = session.run([gen_train_op,  pred_cls], feed_dict={condector_label:np.reshape(_pseudo_label, (BATCH_SIZE, -1)), noise_data : read_noise, real_data: _data})
