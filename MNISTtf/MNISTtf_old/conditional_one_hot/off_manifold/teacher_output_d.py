...
def teacher_model(noise, fake_data_from_student, mode, id_, dim, batch_size, critic_iters, lambda_, iters, output_dim, l2_lambda, adaptor_input_len = 4, real_data =None, n_classes = 10, n_pixels = 28, testing = False):
    ...
    fake_data_set = []
    if testing:
        noise0,noise1,noise2,noise3,noise4,noise5,noise6,noise7,noise8 = noise,noise,noise,noise,noise,noise,noise,noise, noise 
    else:
