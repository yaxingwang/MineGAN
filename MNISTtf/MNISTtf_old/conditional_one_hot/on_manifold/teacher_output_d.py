...
def teacher_model(noise, fake_data_from_student, mode, id_, dim, batch_size, critic_iters, lambda_, iters, output_dim, l2_lambda, adaptor_input_len = 4, real_data =None, n_classes = 10, n_pixels = 28):
    ...
    fake_data_set = []
    noise0,noise1,noise2,noise3,noise4,noise5,noise6,noise7,noise8,noise9 = tf.split(noise, num_or_size_splits=N_CLASSES, axis=1)  
    noise_set = [noise0,noise1,noise2,noise3,noise4,noise5,noise6,noise7,noise8,noise9 ]  
    for i in xrange(10):
        noise=noise_set[i]
